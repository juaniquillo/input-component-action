...
use Juaniquillo\InputComponentAction\Concerns\IsDisableBag;
...
final class DefaultDisableBag implements DisableBag, ErrorDisable, HelpTextDisable, InputDisable, LabelDisable, WrapperDisable
{
    use IsDisableBag;
}
