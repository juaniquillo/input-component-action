...
class Container_144f0badb5 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_144f0badb5 $container)
			{
	...
	public function createServiceContainer(): Container_144f0badb5
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\juani\AppData\Local\Temp\nosDAEA.tmp|0|*|*|C:\php-8.4.16\php.ini|3.5.1',
				'ZES_ENABLE_SYSMAN' => '1',
				'GEMINI_CLI' => '1',
				'TERM' => 'xterm-256color',
				'PAGER' => 'cat',
