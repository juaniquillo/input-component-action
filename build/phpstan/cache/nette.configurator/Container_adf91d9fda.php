...
class Container_adf91d9fda extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_adf91d9fda $container)
			{
	...
	public function createServiceContainer(): Container_adf91d9fda
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '30',
				'PHPRC' => 'C:\Users\juani\AppData\Local\Temp\i1s8BCD.tmp',
				...
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\juani\AppData\Local\Temp\i1s8BCD.tmp|0|*|*|C:\php-8.4.16\php.ini|3.5.1',
				'ZES_ENABLE_SYSMAN' => '1',
			],
		];
	}
