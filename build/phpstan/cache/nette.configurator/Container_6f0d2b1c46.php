...
class Container_6f0d2b1c46 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_6f0d2b1c46 $container)
			{
	...
	public function createServiceContainer(): Container_6f0d2b1c46
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '30',
				'PHPRC' => 'C:\Users\juani\AppData\Local\Temp\h0l728A.tmp',
				...
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\juani\AppData\Local\Temp\h0l728A.tmp|0|*|*|C:\php-8.4.16\php.ini|3.5.1',
				'ZES_ENABLE_SYSMAN' => '1',
			],
		];
	}
