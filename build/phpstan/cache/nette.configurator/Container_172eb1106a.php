...
class Container_172eb1106a extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_172eb1106a $container)
			{
	...
	public function createServiceContainer(): Container_172eb1106a
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => ['C:\Users\juani\Code\packages\input-component-action\src'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'LINES' => '30',
				'PHPRC' => 'C:\Users\juani\AppData\Local\Temp\pbbEB64.tmp',
				...
				'WT_SESSION' => '3e453153-b5f6-4921-a2f3-480ed40c7e63',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\juani\AppData\Local\Temp\pbbEB64.tmp|0|*|*|C:\php-8.4.16\php.ini|3.5.1',
				'ZES_ENABLE_SYSMAN' => '1',
			],
		];
	}
